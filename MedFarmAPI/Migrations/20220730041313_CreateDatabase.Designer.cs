...
namespace MedFarmAPI.Migrations
{
    ...
    [Migration("20220730041313_CreateDatabase")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MedFarmAPI.Entities.Appointment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MedFarmAPI.Entities.Client", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MedFarmAPI.Entities.Doctor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MedFarmAPI.Entities.Drugstore", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MedFarmAPI.Entities.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MedFarmAPI.Entities.Appointment", b =>
                {
                    b.HasOne("MedFarmAPI.Entities.Client", "Client")
                    ...
                    b.HasOne("MedFarmAPI.Entities.Doctor", "Doctor")
                        .WithMany("Appointments")
            ...
            modelBuilder.Entity("MedFarmAPI.Entities.Order", b =>
                {
                    ...
                    b.HasOne("MedFarmAPI.Entities.Drugstore", "Drugstores")
                        .WithMany("Orders")
